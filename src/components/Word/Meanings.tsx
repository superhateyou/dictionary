  ...
  return (<div className='p-2 m-5 bg-blue-300 rounded-lg'>
      ...
      {Object.values(meanings)?.map((el: IMeanings, indexMeaning) => <div key={indexMeaning}
        ...
        {el.definitions ? <div className='font-bold'>Definitions:
          {el.definitions.map((element: IDefinition, indexDefinition) => <div className='p-3 rounded-lg m-5 bg-blue-100'
                                                                              key={indexDefinition}>
            <div>Definition:
